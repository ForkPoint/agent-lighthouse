---
audit: operability-safety/nav-aria-label
audit_id: "7.3"
category: operability-safety
source_file: packages/core/src/audits/operability-safety/nav-aria-label.ts
slug: nav-aria-label
...
> operability-safety · source `nav-aria-label.ts` · review verdict **merge** · evidence grade **A** · disposition: **merge (approved 2026-08-21)**

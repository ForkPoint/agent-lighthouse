---
audit: operability-safety/hsts-header
audit_id: "8.2"
category: operability-safety
source_file: packages/core/src/audits/operability-safety/hsts-header.ts
slug: hsts-header
...
> operability-safety · source `hsts-header.ts` · review verdict **merge** · evidence grade **B** · disposition: **merge (approved 2026-08-21)**

...
**Sources:** [HTML Standard — the time element](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-time-element) (verified 2026-08-20) · [htmldate extractors.py (date XPath constants)](https://raw.githubusercontent.com/adbar/htmldate/master/htmldate/extractors.py) (verified 2026-08-20) · [htmldate: A Python package to extract publication dates from web pages](https://joss.theoj.org/papers/10.21105/joss.02439) (verified 2026-08-20) · [trafilatura core functions documentation](https://trafilatura.readthedocs.io/en/latest/corefunctions.html) (verified 2026-08-20) · [HTML Accessibility API Mappings 1.0](https://www.w3.org/TR/html-aam-1.0/) (verified 2026-08-20) · [Add a Byline Date to Google Search Results](https://developers.google.com/search/docs/appearance/publication-dates) (verified 2026-08-20)

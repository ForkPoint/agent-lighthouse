...
This audit was a delete candidate and went through dedicated adversarial research. Full dossier: [docs/evidence/sunset/structured-data/action-schema.md](../../sunset/structured-data/action-schema.md). Outcome: **dead**, grade D.

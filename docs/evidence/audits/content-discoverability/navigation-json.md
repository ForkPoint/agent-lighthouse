...
This audit was a delete candidate and went through dedicated adversarial research. Full dossier: [docs/evidence/sunset/content-discoverability/navigation-json.md](../../sunset/content-discoverability/navigation-json.md). Outcome: **dead**, grade D.

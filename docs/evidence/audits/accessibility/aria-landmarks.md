---
audit: accessibility/aria-landmarks
audit_id: "7.2"
category: accessibility
source_file: packages/core/src/audits/accessibility/aria-landmarks.ts
slug: aria-landmarks
review_verdict: fix
severity: high
evidence_grade: A
...
> accessibility · source `aria-landmarks.ts` · review verdict **fix** · evidence grade **A** · disposition: **keep — fix required**

---
audit: generative-engine/descriptive-urls
audit_id: "10.15"
category: generative-engine
source_file: packages/core/src/audits/generative-engine/descriptive-urls.ts
...
**Sources:** [URL Structure Best Practices for Google](https://developers.google.com/search/docs/crawling-indexing/url-structure) · [How Do Technical SEO Factors Impact AI Search? [Study]](https://www.semrush.com/blog/technical-seo-impact-on-ai-search-study/) · [AI Features and Your Website](https://developers.google.com/search/docs/appearance/ai-features) · [Does Anthropic crawl data from the web, and how can site owners block the crawler?](https://support.claude.com/en/articles/8896518-does-anthropic-crawl-data-from-the-web-and-how-can-site-owners-block-the-crawler) · [Optimizing Visibility in Generative Engines: A Critical Survey of Generative Engine Optimization (2023–2026)](https://arxiv.org/html/2607.14035v1)

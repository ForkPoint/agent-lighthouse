...
- No validation that the URL is a person profile. A link to the publisher's LinkedIn _company_ page, or `https://en.wikipedia.org/wiki/Cat`, passes as author verification.

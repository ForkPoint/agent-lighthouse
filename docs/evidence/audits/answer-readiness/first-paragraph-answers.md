...
**Evidence:**
- Position matters, measured at scale: Kevin Indig's analysis of 1.2 million AI answers and 18,012 verified citations found "44.2% of citations come from the first 30% of content", "31.1% come from the middle (30–70%)" and "24.7% come from the final third, with a sharp drop near the footer" (drawn from a wider corpus of 3 million ChatGPT responses and 30 million citations, matched with sentence-transformer embeddings) — https://searchengineland.com/chatgpt-citations-content-study-469483 (verified 2026-08-21)

---
audit: operability-safety/security-txt
audit_id: "8.7"
category: operability-safety
source_file: packages/core/src/audits/operability-safety/security-txt.ts
slug: security-txt
...
> operability-safety · source `security-txt.ts` · review verdict **delete** · evidence grade **C** · disposition: **informative, weight 0 (approved 2026-08-21)**

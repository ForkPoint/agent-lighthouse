---
audit: agent-tools/no-blocking-captcha
audit_id: "5.18"
category: agent-tools
source_file: packages/core/src/audits/agent-tools/no-blocking-captcha.ts
...
> agent-tools · source `no-blocking-captcha.ts` · review verdict **fix** · evidence grade **unrated** · disposition: **keep — fix required**

---
audit: agent-tools/contact-form
audit_id: "5.15"
category: agent-tools
source_file: packages/core/src/audits/agent-tools/contact-form.ts
slug: contact-form
review_verdict: fix
severity: medium
evidence_grade: C
...
> agent-tools · source `contact-form.ts` · review verdict **fix** · evidence grade **C** · disposition: **keep — fix required**
...
**Sources:** [ContactPoint — schema.org Type](https://schema.org/ContactPoint) · [Organization schema markup](https://developers.google.com/search/docs/appearance/structured-data/organization) · [RFC 3966 — The tel URI for Telephone Numbers](https://www.rfc-editor.org/rfc/rfc3966.html) · [The rise of the AI crawler](https://vercel.com/blog/the-rise-of-the-ai-crawler) · [BrowserArena: Evaluating LLM Agents on Real-World Web Navigation Tasks](https://arxiv.org/abs/2510.02418) · [AI Features and Your Website](https://developers.google.com/search/docs/appearance/ai-features) · [Google's Guide to Optimizing for Generative AI Features on Google Search](https://developers.google.com/search/docs/fundamentals/ai-optimization-guide)

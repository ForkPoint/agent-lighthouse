---
audit: answer-engine/question-headings
audit_id: "9.2"
category: answer-engine
source_file: packages/core/src/audits/answer-engine/question-headings.ts
...
**Sources:** [Google's Guide to Optimizing for Generative AI Features on Google Search](https://developers.google.com/search/docs/fundamentals/ai-optimization-guide) · [Structural Feature Engineering for Generative Engine Optimization: How Content Structure Shapes Citation Behavior](https://arxiv.org/html/2603.29979v1) · [44% of ChatGPT citations come from the first third of content: Study](https://searchengineland.com/chatgpt-citations-content-study-469483) · [We Studied 200,000 AI Overviews: Here's What We Learned](https://www.semrush.com/blog/ai-overviews-study/) · [AI Citation Ranking Factors Analysis](https://signal.zyppy.com/p/ai-citation-ranking-factors) · [C-SEO Bench: Does Conversational SEO Work?](https://arxiv.org/abs/2506.11097) · [Optimizing Visibility in Generative Engines: A Critical Survey of Generative Engine Optimization (2023–2026)](https://arxiv.org/html/2607.14035v1)

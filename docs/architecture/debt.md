...
| --: | :----------------------------------- | :------------------- | :----------------------------------- |
|   — | *(None — all standing debts closed)* | Closed               | Resolved (corpus-evidence-gate.test) |

All architectural, test, and evidence-gating debts identified during the hostile-state
and migration roadmap branches have been resolved and closed.

...
| 8 | Bound what you fetch | — | **DEBT** — 33 audits, 33 private caps, nothing sums them; the truthful figure is **36** — 31 audits calling `ctx.fetch` in their own file plus 5 fetching through the shared `_mcp-client.ts` helper |

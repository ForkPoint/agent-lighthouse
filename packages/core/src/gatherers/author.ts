...
const authorProbeCache = new WeakMap<object, Map<string, Promise<FetchResult | undefined>>>();

export function probeAuthorUrl(
  ctx: { fetch: CheckContext['fetch'] },
  url: string,
  options: { method?: 'GET' | 'HEAD'; followRedirects?: boolean; headers?: Record<string, string> } = {},

...
- [ ] TODO `crawler-permissions/sensitive-paths` — grade A (approved 2026-08-21) · [dossier](../../../../docs/evidence/deletions/crawler-permissions/sensitive-paths.md)
...
- [ ] TODO `semantic-html/aside-element` — grade B (approved 2026-08-21) · [dossier](../../../../docs/evidence/deletions/semantic-html/aside-element.md)
...
- [ ] TODO `meta-tags/ai-content-declaration` — target tier experimental (pending triage approval) · [dossier](../../../../docs/evidence/audits/meta-tags/ai-content-declaration.md)
...
- [ ] TODO `crawler-permissions/bytespider` — target tier scored (pending triage approval) · [dossier](../../../../docs/evidence/audits/crawler-permissions/bytespider.md)
...
- [ ] TODO `crawler-permissions/cohere-ai` — target tier scored (pending triage approval) · [dossier](../../../../docs/evidence/audits/crawler-permissions/cohere-ai.md)
  - Same consolidation into ai-bot-directives..
- [ ] TODO `crawler-permissions/youbot` — target tier scored (pending triage approval) · [dossier](../../../../docs/evidence/audits/crawler-permissions/youbot.md)
  - Same consolidation into ai-bot-directives..
- [ ] TODO `crawler-permissions/diffbot` — target tier scored (pending triage approval) · [dossier](../../../../docs/evidence/audits/crawler-permissions/diffbot.md)
  - Same consolidation into ai-bot-directives..
- [ ] TODO `crawler-permissions/ai2bot` — target tier scored (pending triage approval) · [dossier](../../../../docs/evidence/audits/crawler-permissions/ai2bot.md)
  - Same consolidation into ai-bot-directives..
- [ ] TODO `crawler-permissions/tdm-rep` — target tier experimental (pending triage approval) · [dossier](../../../../docs/evidence/audits/crawler-permissions/tdm-rep.md)

...
export const TRAINING_CRAWLERS: CrawlerBot[] = [
  ...
  { botName: 'Google-Extended', displayName: 'Google-Extended', category: 'training' },
  { botName: 'anthropic-ai', displayName: 'anthropic-ai / ClaudeBot', category: 'training', aliases: ['ClaudeBot'] },
  { botName: 'PerplexityBot', displayName: 'PerplexityBot', category: 'training' },
  { botName: 'Applebot-Extended', displayName: 'Applebot-Extended', category: 'training' },
  { botName: 'CCBot', displayName: 'CCBot', category: 'training' },
  { botName: 'Meta-ExternalAgent', displayName: 'Meta-ExternalAgent', category: 'training' },
...
export const REALTIME_CRAWLERS: CrawlerBot[] = [
  { botName: 'ChatGPT-User', displayName: 'ChatGPT-User', category: 'realtime' },
  { botName: 'Claude-User', displayName: 'Claude-User', category: 'realtime' },
  { botName: 'OAI-SearchBot', displayName: 'OAI-SearchBot', category: 'realtime' },
  { botName: 'Meta-ExternalFetcher', displayName: 'Meta-ExternalFetcher', category: 'realtime' },
  { botName: 'Bravebot', displayName: 'Bravebot', category: 'realtime' },
  { botName: 'DuckAssistBot', displayName: 'DuckAssistBot', category: 'realtime' },
  { botName: 'MistralAI-User', displayName: 'MistralAI-User', category: 'realtime' },
  { botName: 'Claude-SearchBot', displayName: 'Claude-SearchBot', category: 'realtime' },
];

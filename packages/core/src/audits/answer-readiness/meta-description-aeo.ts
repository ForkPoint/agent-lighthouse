// TODO(merge): folds into answer-readiness/meta-description in Plan 4 (approved 2026-08-21).

// TODO(redeem): this audit survives only if rewritten (pending triage approval). Target tier: scored.
// Evidence dossier: docs/evidence/audits/answer-readiness/meta-description-aeo.md
// Required rework:
...
export class MetaDescriptionAeoAudit extends Audit {
  static override meta: AuditMeta = {
    id: 'answer-readiness/meta-description-aeo',
    ...
    evidenceGrade: 'C',
    tier: 'informative',
    dossier: 'docs/evidence/audits/answer-readiness/meta-description-aeo.md',

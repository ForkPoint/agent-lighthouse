...
describe("AboutCredentialsAudit", () => {
  ...
  it("passes when about page has 2+ credential keywords", async () => {
    const ctx = mockCheckContext([], {
      "/about/": mockFetchResult(
        "Our team has years of experience in software.",
        200,
        "text/html",
      ),
    });
  ...
  it("warns when about page lacks credential keywords", async () => {
    const ctx = mockCheckContext([], {
      "/about/": mockFetchResult(
        "Hello world, a page about our company.",
        200,
        "text/html",
      ),
    });
  ...
  it("uses /about-us/ from rootFiles when /about/ is absent", async () => {
    const ctx = mockCheckContext([], {
      "/about-us/": mockFetchResult(
        "Our professional team has expertise in software.",
        200,
        "text/html",
      ),
    });

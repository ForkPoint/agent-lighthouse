// TODO(merge): folds into answer-readiness/dates-on-content in Plan 4 (approved 2026-08-21).
...
export class LastUpdatedIndicatorAudit extends Audit {
  static override meta: AuditMeta = {
    id: 'answer-readiness/last-updated-indicator',
    ...
    evidenceGrade: 'B',
    tier: 'scored',
    dossier: 'docs/evidence/audits/answer-readiness/last-updated-indicator.md',

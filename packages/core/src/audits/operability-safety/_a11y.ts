/**
 * Operability & safety audits backed by our a11y rule engine (see ./engine).
 *
 * TODO(split): one audit = one file — this module still holds 17 audits. The
 * per-audit split into operability-safety/<slug>.ts happens in Plan 4 (§6 of
 * docs/evidence/v2-audit-map.md); Plan 3 only restamps their meta.
 *
 ...
 */
function graded(grade: EvidenceGrade, slug: string) {

// TODO(merge): folds into operability-safety/form-actionability in Plan 4 (approved 2026-08-21).
...
export class WebmcpInputQualityAudit extends Audit {
  static override meta: AuditMeta = {
    id: 'operability-safety/webmcp-input-quality',
    ...
    evidenceGrade: 'B',
    tier: 'scored',
    dossier: 'docs/evidence/audits/operability-safety/webmcp-input-quality.md',

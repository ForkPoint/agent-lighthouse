...
export class BehaviorAnnotationCoverageAndClaimConsistencyAudit extends Audit {
  static override meta: AuditMeta = {
    ...
    description: "Roadmap check. Measures what fraction of tools carry the behavior-hint annotations hosts use to decide whether to auto-approve a call, then uses an LLM judge to flag annotations that contradict the tool's own name and description (a tool named delete_* or refund_* asserting readOnlyHint: true).",
    ...
    guidance: {
      ...
      effort: 'moderate',
      docsUrl: 'https://github.com/ForkPoint/agent-lighthouse/blob/main/docs/evidence/proposals/mcp-server-quality/behavior-annotation-coverage-and-claim-consistency.md',

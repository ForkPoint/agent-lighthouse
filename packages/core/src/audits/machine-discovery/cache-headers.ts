// TODO(merge): folds into machine-discovery/ai-file-delivery in Plan 4 (approved 2026-08-21).
...
export class CacheHeadersAudit extends Audit {
  static override meta: AuditMeta = {
    id: 'machine-discovery/cache-headers',
    ...
    evidenceGrade: 'B',
    tier: 'scored',
    dossier: 'docs/evidence/audits/machine-discovery/cache-headers.md',
    defaultPriority: 'low',
    guidance: {
      impact:

// TODO(merge): folds into machine-discovery/llms-txt-exists in Plan 4 (approved 2026-08-21).
...
export class LlmsTxtLinkAudit extends Audit {
  static override meta: AuditMeta = {
    id: 'machine-discovery/llms-txt-link',
    ...
    evidenceGrade: 'C',
    tier: 'informative',
    dossier: 'docs/evidence/audits/machine-discovery/llms-txt-link.md',

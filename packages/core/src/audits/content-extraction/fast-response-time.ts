// TODO(merge): folds into content-extraction/server-responsiveness in Plan 4 (approved 2026-08-21).
...
export class FastResponseTimeAudit extends Audit {
  static override meta: AuditMeta = {
    id: 'content-extraction/fast-response-time',
    ...
    evidenceGrade: 'B',
    tier: 'scored',
    dossier: 'docs/evidence/audits/content-extraction/fast-response-time.md',

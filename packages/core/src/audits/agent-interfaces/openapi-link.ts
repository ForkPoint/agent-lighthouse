// TODO(merge): folds into agent-interfaces/openapi-exists in Plan 4 (approved 2026-08-21).
// TODO(redeem): this audit survives only if rewritten (pending triage approval). Target tier: scored.
// Evidence dossier: docs/evidence/audits/agent-interfaces/openapi-link.md
// Required rework:
...
export class OpenApiLinkAudit extends Audit {
  static override meta: AuditMeta = {
    id: 'agent-interfaces/openapi-link',
    ...
    evidenceGrade: 'B',
    tier: 'scored',
    dossier: 'docs/evidence/audits/agent-interfaces/openapi-link.md',
    defaultPriority: 'low',
    guidance: {
      impact:

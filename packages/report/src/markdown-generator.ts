...
${rows}
${advisoryLine}
*Generated by [Agent Lighthouse](${PROJECT_URL}) · Open-source website checks for AI readiness. [Apache-2.0](https://github.com/ForkPoint/agent-lighthouse)*
`;
}
